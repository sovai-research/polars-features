...
Long memory (:mod:`._longmemory`)
    ...
    :mod:`polars_features._ffd` **data driven per entity**, fitted train-only.
...
--------
>>> import polars as pl
>>> from polars_features.econ.features import har_features, evt_features
...
from polars_features.econ.features._decompose import (
    CausalSeasonalDecomposer,
    causal_seasonal_decompose,
    decompose_features,
    seasonal_strength,
)
from polars_features.econ.features._evt import (
    GPDFit,
    evt_features,
    gpd_fit,
    hill_index,
...
from polars_features.econ.features._harrv import (
    HARModel,
    bipower_variation,
...
from polars_features.econ.features._liquidity import (
    amihud_illiquidity,
    amivest_liquidity,
    liquidity_features,
    roll_spread,
)
from polars_features.econ.features._longmemory import (
    AutoFracDiff,
    LongMemoryResult,
...
from polars_features.econ.features._nelson_siegel import (
    NelsonSiegel,
    NelsonSiegelFit,
...
from polars_features.econ.features._unitroot import (
    NgPerronResult,
