...
The fixed-width fractional-differencing kernel in :mod:`polars_features._ffd`
...
* :class:`AutoFracDiff` -- a :class:`~polars_features.core.protocol.PanelTransformer`
...
class AutoFracDiff(PanelTransformer):
    ...
    (:func:`polars_features._ffd.frac_diff_expr`) under ``.over(entity)``.
    ...
    threshold : float
        ...
        :func:`polars_features._ffd.ffd_weights`.
