...
PanelKit's other pillars produce features (``feature_extractors``), factors
...
**Splitting** (:mod:`~polars_features.validation._cv`) — Combinatorial Purged CV
...
**Selection statistics** (:mod:`~polars_features.validation._selection_stats`) —
...
**Forecast comparison** (:mod:`~polars_features.validation._forecast_tests`) —
...
**Resampling** (:mod:`~polars_features.validation._bootstrap`) — moving-block,
...
--------
>>> import numpy as np
>>> from polars_features.validation import cpcv_backtest_paths, deflated_sharpe_ratio
...
from polars_features.validation._bootstrap import (
...
from polars_features.validation._cv import (
...
from polars_features.validation._forecast_tests import (
