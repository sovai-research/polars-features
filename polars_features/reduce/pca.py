...
:class:`polars_features.reduce._base._PanelReducer`: it only names the sklearn
...
from polars_features.reduce._base import _PanelReducer
...
class PanelPCA(_PanelReducer):
    ...
    See :class:`~polars_features.reduce._base._PanelReducer` for the full
    parameter list.
    """
...
class PanelKernelPCA(_PanelReducer):
    ...
    **kwargs
        See :class:`~polars_features.reduce._base._PanelReducer`.
    """
...
def _require_umap() -> Any:
    ...
    try:
        ...
        raise ImportError(
            ...
            "not installed. Install it with `pip install polars-features[umap]` "
...
def reduce_features(
    ...
    **kwargs: Any,
    ...
    n_components, columns, entity, time, **kwargs
        ...
        :class:`~polars_features.reduce._base._PanelReducer`).
