...
Part of PanelKit's **interactions theme**: higher-order structure in the *data*
(the cumulant factors of :mod:`polars_features.reduce._hfa`, ``order=3|4``) and
...
Notes
-----
:mod:`polars_features.select._unsupervised` carries near-identical private
