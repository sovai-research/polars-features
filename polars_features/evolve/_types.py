"""Shared types and contracts for PanelKit's evolutionary feature search.

This module is the *spine* of :mod:`polars_features.evolve`. It defines the
vocabulary that every other module in the package codes against, and it has
**no third-party imports beyond numpy and polars** — matching PanelKit's
light-core policy (see :mod:`polars_features._deps`).
...
GP libraries surveyed, **zero** have any lookahead concept; this is PanelKit's
