...
from polars_features.base.forecaster import FORECAST_STRATEGIES, SUPPORTED_FREQ, Forecaster
from polars_features.base.transformer import Transformer
from polars_features.forecasting.knn import knn
from polars_features.forecasting.linear import elastic_net, lasso, linear_model, ridge

try:
    from polars_features.forecasting.lightgbm import lightgbm
except ImportError:
    pass
...
class AutoForecaster(Forecaster):
    ...
    **kwargs : Mapping[str, Any]
    ...
    def _fit(self, y: pl.LazyFrame, X: Optional[pl.LazyFrame] = None):
        from polars_features.forecasting._ar import fit_cv
    ...
    def _predict(self, fh: int, X: Optional[pl.LazyFrame] = None):
        from polars_features.forecasting._ar import predict_autoreg
