...
numpy k-Shape engine (:mod:`polars_features.cluster._kshape`) and emits, per
...
* The tensor is built causally (forward-fill only, expanding z-norm) via
  :func:`polars_features.cluster._tensor.build_tensor` -- no ``bfill``, no
  full-sample scaler.
...
from polars_features.cluster._kshape import KShapeCore, ncc
from polars_features.cluster._tensor import build_tensor
