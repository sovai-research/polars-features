...
The fifth pillar of PanelKit. Every statistic here is a function of data up to
...
What's here
-----------
:mod:`~polars_features.detect._moments` -- **the prefix-sum engine**
...
:mod:`~polars_features.detect._bsadf` -- **recursive right-tailed unit root**
...
:mod:`~polars_features.detect._critvals` -- **calibration without leakage**
...
:mod:`~polars_features.detect._monitors` -- **O(1) sequential detectors**
...
:mod:`~polars_features.detect._panel` -- **cross-sectional aggregation**
...
--------
>>> import numpy as np
>>> from polars_features.detect import bsadf_sequence, focus
...
from polars_features.detect._bsadf import (
    bsadf_panel,
    bsadf_sequence,
    gsadf,
    min_admissible_window,
)
from polars_features.detect._critvals import (
    DEFAULT_TABLE_SPEC,
    align_cv,
...
from polars_features.detect._monitors import (
    end_of_sample_S,
    focus,
    hb_cusum,
    page_cusum,
...
from polars_features.detect._panel import (
    breadth,
