PanelKit supports both individual forecasters and forecasters with automated lags / hyperparameter tuning.
...
::: polars_features.base.forecaster.Forecaster

## `auto_forecaster`

::: polars_features.forecasting.automl.AutoForecaster

[^1]: https://arxiv.org/abs/2005.01571

::: polars_features.forecasting
