...
:func:`panelary.econ.features._common.interp_pvalue`); they are exact at
...
class StationarityDifferencer(PanelTransformer):
    ...
    --------
    >>> import polars as pl
    >>> from panelary.econ.features import StationarityDifferencer
    ...
    def _fit(self, panel: PanelFrame) -> None:
        ...
        from panelary.econ.features._common import entity_arrays
