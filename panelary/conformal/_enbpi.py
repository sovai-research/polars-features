"""Frame-level ensemble batch prediction intervals (ENBPI).

The functime-era, Polars-frame API: :func:`enbpi` turns per-entity residual
quantiles into prediction intervals for a forecast frame, and
:func:`conformalize` is the convenience wrapper used by the forecasters.
"""
