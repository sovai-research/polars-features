...
:mod:`panelary.detect._moments`: build the blocked cumulative sufficient
...
def bsadf_sequence(
    ...
    *,
    ...
    block : int, default=1000
        Accumulator block length; see :func:`~panelary.detect._moments.cumulative_moments`.
    ...
    --------
    >>> import numpy as np
    >>> from panelary.detect._bsadf import bsadf_sequence
