...
# hint is correct: the installable distribution is `panelary`, not
# `panelary`, so the old hint could not be pasted into a shell.
...
def _get_client() -> OpenAI:
    ...
    ``panelary.llm`` required a live API key, and the failure was a
