...
from panelary.forecasting.linear import elastic_net, lasso, linear_model, ridge

with contextlib.suppress(ImportError):
    from panelary.forecasting.lightgbm import lightgbm
...
class AutoForecaster(Forecaster):
    ...
    **kwargs : Mapping[str, Any]
    ...
    def _fit(self, y: pl.LazyFrame, X: pl.LazyFrame | None = None):
        from panelary.forecasting._ar import fit_cv
    ...
    def _predict(self, fh: int, X: pl.LazyFrame | None = None):
        from panelary.forecasting._ar import predict_autoreg
