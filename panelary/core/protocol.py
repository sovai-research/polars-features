...
transformer / estimator in Panelary must honour. The contract is the moat:
...
class PanelTransformer(abc.ABC):
    ...
    **The guarantee.** If ``leakage_safe is True``, then for any walk-forward or
    ...
    transformer composable inside :class:`~panelary.core.pipeline.Pipeline`
    ...
    def _check_input(panel: object, *, method: str) -> PanelFrame:
        ...
        :class:`~panelary.core.pipeline.Pipeline`, where the value passed
