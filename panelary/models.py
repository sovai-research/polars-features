...
This module provides the estimator layer of Panelary: thin, panel-aware wrappers
around ordinary sklearn-style estimators that honour the
:class:`~panelary.core.protocol.PanelEstimator` contract. They
...
one at the end of a :class:`~panelary.core.pipeline.Pipeline` keeps the
